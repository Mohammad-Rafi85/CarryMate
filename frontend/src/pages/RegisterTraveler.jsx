                    ...
                    {success ? (
                        ...
                        <div className="w-full max-w-md mx-auto">
                            <div className="mb-10 text-center">
                                <h2 className="text-3xl font-bold text-slate-900 mb-3">Create Traveler Account</h2>
                                <p className="text-slate-500 font-medium tracking-tight">Just the essentials to get you earning securely.</p>
                            </div>
                            ...
                            <form onSubmit={handleSubmit} className="space-y-6">
                                ...
                                <button type="submit" className="btn-primary bg-emerald-600 hover:bg-emerald-700 w-full py-4 text-base mt-2 shadow-emerald-200 shadow-xl" disabled={loading}>
